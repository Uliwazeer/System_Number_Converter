...
void exitScreen()
{
    screenCleaner();
    printf("-------------------------------------------\n");
    printf(" >>> Creator: Ali Wazeer <<< \n");
    printf("-------------------------------------------\n\n");

    printf("> GitHub: https://github.com/Uliwazeer \n");
    printf("> Twitter: https://twitter.com/Aliwazeer \n");
    printf("> LinkedIn: https://www.linkedin.com/in/Aliwazeer \n\n");
